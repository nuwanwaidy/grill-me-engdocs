...
|---|---|---|---|
| Benefit | Value delivered if this epic is completed | Nice to have | Unlocks blocked value stream |
| Penalty | Cost of not completing this epic | No impact | Blocks objective or trust contract |
| Cost | Engineering effort across the sprint cycle | Trivial | Major cross-team effort |
| Risk | Uncertainty, dependencies, open TBDs | Well understood | High unknowns |
