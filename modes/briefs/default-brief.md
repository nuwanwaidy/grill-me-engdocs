...
|---|---|---|---|---|---|---|
| Benefit | Value if built | Nice to have | Useful | Meaningful | High value | Unlocks blocked value stream |
| Penalty | Cost of not building | No impact | Minor gap | Noticeable | Significant | Blocks objective or trust contract |
| Cost | Effort to deliver | Trivial | Small | Moderate | Significant | Major architecture work |
| Risk | Uncertainty and dependencies | Well understood | Low | Moderate | High | Blockers outside your control |
...
Every brief output must cite at least one applicable SIEM policy term.
...
| 2 | All four sections present: Problem/Opportunity, Strategic Fit, Proposed Approach, Expected Value | Yes |
| 3 | Key Assumptions & Risks table has ≥1 row | Yes |
| 4 | Out of Scope section present | Yes |
| 5 | At least one `BusinessGoals.*` term named | Yes |
| 6 | At least one Workflow ID named | Yes |
| 7 | At least one SIEM policy term cited (SEC-POL-* · SEC-STD-* · SEC-RB-* · SEC-SOP-*) | Yes |
| 8 | RICE score computed (all four components present) | Yes |
| 9 | Wiegers value score computed (all four dimensions present, 1–5 scale) | Yes |
| 10 | Handoff block present with all fields populated | Yes |
